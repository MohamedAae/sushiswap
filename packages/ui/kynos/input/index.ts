...
export const DEFAULT_INPUT_BG = 'bg-[#f5f5f5]'
export const DEFAULT_INPUT_HOVER_BG = 'hover:bg-[#f5f5f5]'
...
export const DEFAULT_INPUT_APPEARANCE = 'rounded-xl min-h-[44px] w-full truncate'
...
export const Input = { Address, DatetimeLocal, DateLocal, Time, Counter, Numeric, Percent }
